...
INSERT INTO products VALUES (77, 'xyz', 22, 3, '1 kg', 45, 5, 0, 0, 0);
INSERT INTO products VALUES (2, 'Y Z Bilgisayar', 1, 1, '24 - 12 oz bottles', 19, 17, 40, 25, 1);
INSERT INTO products VALUES (1, 'Y Z Televizyon', 8, 1, '10 boxes x 30 bags', 18, 39, 0, 10, 1);
...
ALTER TABLE ONLY orders
    ADD CONSTRAINT "FK1CustomerOrder" FOREIGN KEY ("CustomerID") REFERENCES customers("CustomerID") MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY order_details
    ADD CONSTRAINT "OrderOrderDetail" FOREIGN KEY ("OrderID") REFERENCES orders("OrderID") MATCH FULL;
...
ALTER TABLE ONLY order_details
    ADD CONSTRAINT "ProductOrderDetail" FOREIGN KEY ("ProductID") REFERENCES products("ProductID") MATCH FULL;
...
ALTER TABLE ONLY products
    ADD CONSTRAINT "ProductSupplier" FOREIGN KEY ("SupplierID") REFERENCES suppliers("SupplierID") MATCH FULL;
...
ALTER TABLE ONLY employees
    ADD CONSTRAINT lnk_employees_employees FOREIGN KEY ("ReportsTo") REFERENCES employees("EmployeeID") MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY orders
    ADD CONSTRAINT lnk_employees_orders FOREIGN KEY ("EmployeeID") REFERENCES employees("EmployeeID") MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY employeeterritories
    ADD CONSTRAINT lnk_employeeterritories_employees FOREIGN KEY ("EmployeeID") REFERENCES employees("EmployeeID") MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY employeeterritories
    ADD CONSTRAINT lnk_employeeterritories_territories FOREIGN KEY ("TerritoryID") REFERENCES territories("TerritoryID") MATCH FULL ON UPDATE CASCADE ON DELETE CASCADE;
