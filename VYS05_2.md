...
* Ogrenciler tablosundan ogrenciNo bilgisi 1512B100010 olan öğrenciyi seç.
...
* 3. Hafta ders notlarında geliştirilen Üniversite Bilgi Sistemine ait veritabanının ilişkisel şeması (alt şema) aşağıdaki gibidir. İstenen sorgulara ait biçimsel ifadeleri ilişkisel cebir ile yapınız.
