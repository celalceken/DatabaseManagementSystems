...
* * EXPLAIN ile pg_statistic katalog tablosuna dayalı olarak, başarımla ilgili tahmini değerler döndürülür. 
* * ANLYZE ile birlikte sorgu gerçekten çalıştırılarak gerçek değerler döndürülür. (INSERT, UPDATE, DELETE vb. işlemler için dikkatli kullanılmalıdır)
